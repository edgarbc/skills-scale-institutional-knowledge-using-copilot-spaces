...
- Proposed team / roles (PM, PdM, Developers, QA/Testing, UX Designer, Data Analyst, Customer Success Manager):

Reference: [Cross-Functional RACI and Hand-offs](./octoacme-raci-and-handoffs.md)
